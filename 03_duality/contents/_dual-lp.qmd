...
* The vector $\bm{x}$ is the variable of the primal program, and $\bm{y}$ is he
...
matrix of the dual,
4. Every primal variable corresponds o a constraint in the dual, and its sign
...
::: {.callout-tip icon=false}
## Dual Interpretation
Imagine a pharmaceutical company that prodcues in pill form each of the
